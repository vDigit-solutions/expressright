...
public class RegistrationController {
	...
	@RequestMapping("do")
	public Map<String, Object> registerUserJson(@Valid @RequestBody RegistrationBean registrationBean,
			BindingResult bindingResult, @RequestParam(required = false, defaultValue = "3") Integer apptype,
			@RequestParam(required = false, defaultValue = "2") Integer reg_from,
