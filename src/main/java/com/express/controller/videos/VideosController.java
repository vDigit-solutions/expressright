...
public class VideosController {
	...
	@RequestMapping
	public List<Map<String, Object>> getAllVideos(@RequestParam(required = false , defaultValue="0") Integer pageNo , @RequestParam(required = false , defaultValue="10") Integer pageSize){
		List<Map<String, Object>> result = null;
		result = videosService.getAllVideos(pageNo , pageSize);
		return result;
	}
	@RequestMapping("recent")
	public List<Map<String, Object>> getRecentVideos(@RequestParam(required = false , defaultValue = "0") Integer pageNo , @RequestParam(required = false , defaultValue = "10") Integer pageSize){
		List<Map<String, Object>> result = null;
	...
	public List<Map<String, Object>> getAllVideosbyTheme(@PathVariable("theme_id") Long theme_id,@RequestParam(required = false , defaultValue="0") Integer pageNo , @RequestParam(required = false , defaultValue="10") Integer pageSize){
		List<Map<String, Object>> result = null;
	...
	public Collection<Map<String, Object>> playBackStarted(
			@RequestParam Long video_id ,@RequestParam Long user_session_id,
	...
	public Map<String, Object> deleteVideos(
			@RequestParam("video_ids[]") Long[] video_ids ,@RequestParam Long user_session_id)
	{
	...
	public Collection<Map<String, Object>> doDeleteVideos(
			@RequestBody com.express.vo.bean.DeleteVideos deleteVideos)
	{
