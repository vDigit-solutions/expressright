...
public class LoginController {
    ...
    public Map<String, Object> doLogin(@Valid LoginBean loginBean , BindingResult bindingResult,
    	...
    	try {
			...
			result = loginService.doLogin(loginBean , bindingResult , request,apptype ,device_type);
		} catch (Exception e) {
    ...
    public Map<String, Object> doLoginJson(@Valid @RequestBody LoginBean loginBean , BindingResult bindingResult,
    		@RequestParam(required = false, defaultValue = "3") Integer apptype,
			@RequestParam(required = false, defaultValue = "2") Integer device_type
			, HttpServletRequest request){
    	Map<String, Object> result = null;
