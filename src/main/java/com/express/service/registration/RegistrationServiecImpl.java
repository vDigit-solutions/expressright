...
public class RegistrationServiecImpl implements RegistrationService {
	...
	@Override
	public Map<String, Object> registerUser(RegistrationBean registrationBean, BindingResult bindingResult, Integer apptype, Integer reg_from , Boolean login) {
		 Map<String, Object> result = new HashMap<>();
	...
	@Override
	public Map<String, Object> forgotPassword(String email_id, Integer apptype,
			Integer reg_from) {
	...
	@Override
	public Map<String, Object> updateProfile(ProfileBean profileBean,
			BindingResult bindingResult, Integer apptype, Integer device_type) {
		Map<String, Object> result =new HashMap<>();
