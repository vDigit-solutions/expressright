...
<link href='//fonts.googleapis.com/css?family=Poiret+One' rel='stylesheet' type='text/css'>
 ...
 <link rel="shortcut icon"
	href="images/appimage/LogoExpressRight.png">
											...
											<form id="form_signup" action="#include/home.jsp">
												...
												<div class="form-group">
						                            <select name="ageGroup" class="form-control" required="required" title="Select age group">
						                                <option value="na" selected="">Choose age (In Yrs)</option>
										...
										<div class="feedback-grids">
											...
											<div class="form-group">
							                   <!--  <label for="email" class="col-sm-1 ">Title</label> -->
							                    <div class="col-sm-11">
							                        <div>
														<input type="text" class="form-control" name="email" placeholder="Enter your valid email" required="required" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" title="Enter a valid email"/>
													</div>
							                    </div>
			...
			<div class="footer">
				<div class="footer-grids">
						...
						<div class="footer-bottom-nav">
							<ul>
								<li><p>Copyright © 2016. All Rights Reserved </p></li>
								<li><a href="#"><img alt="App Store" src="images/appimage/app-store.png"> <span class="appstore">App Store</span></a></li>
								...
								<li><a href="#">Follow us</a></li>
							 	<li><div class="side-bottom-icons" style="margin: 0px!important;">
									<ul class="nav2" >
										...
										<li><a href="https://www.twitter.com/express_right" target="_blank" class="facebook"> </a></li>
										<li><a href="https://www.facebook.com/expressright" target="_blank" class="facebook twitter"> </a></li>
